...
//general rebranding
#define DISTRIBUTION			"Vector0"						//should be kept short. 8 or less letters is good, with no spaces.
#define DISTRIBUTIONLONG		"Skyescloud"					//think of this as your company name. It isn't shown too often, so can be quite long.
#define FULLENGINENAME			"FTEQW"							//nominally user-visible name.
#define ENGINEWEBSITE			"https://skyestuff.itch.io/"	//for shameless self-promotion purposes.
#define BRANDING_ICON			"vector0.ico"				    //The file to use in windows' resource files - for linux your game should include an icon.[png|ico] file in the game's data.

//filesystem rebranding
#define GAME_SHORTNAME			"vec0"			//short alphanumeric description
#define GAME_FULLNAME			"Vector0"	 	//full name of the game we're playing
//#define GAME_BASEGAMES		GAME_SHORTNAME	//comma-separate list of basegame strings to use
#define GAME_PROTOCOL			"Vector0"		//so other games won't show up in the server browser
#define GAME_DEFAULTPORT		49713			//slightly reduces the chance of people connecting to the wrong type of server
